        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0 ">
            <div>
                ...
                <p className='text-gray-500 mb-4'>
                    Be the first hear about new product, exclusive events, and online offers.  
                </p>
                <p className=' font-medium text-sm text-gray-600 mb-6'>Sign up and get 10% off your first order.</p>
                {/* Newslatter form  */}
                <form className="flex">
                <input type="email" placeholder='Enter your email' className='p-3 w-full border-t text-sm border-l border-b border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all'
                required
                />
            ...
            <li>
                <Link to="#" className="text-gray-600 transition-colors">Men's Bottoms Wear</Link>
            </li>
            
            <li>
                <Link to="#" className="text-gray-600 transition-colors">Women's Bottoms Wear</Link>
            </li>
            </ul>
            </div>
            {/* Support links */}
            ...
            <li>
                <Link to="#" className="text-gray-600 transition-colors">FAQs</Link>
            </li>
